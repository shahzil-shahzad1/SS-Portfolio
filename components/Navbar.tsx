...
const Navbar = ({ activeSectionId, pages }: NavbarProps) => {
  ...
  return (
    <nav className="fixed top-3 left-1/2 -translate-x-1/2 z-50 bg-[#18181B] shadow-md rounded-full w-fit">
      {/* Desktop Menu */}
      <ul className="hidden md:flex justify-center items-center gap-2 px-2 py-4">
      ...
      {/* Mobile Dropdown */}
      {menuOpen && (
        <div className="absolute top-full left-0 w-full bg-[#18181B] rounded-lg shadow-md mt-2 md:hidden">
